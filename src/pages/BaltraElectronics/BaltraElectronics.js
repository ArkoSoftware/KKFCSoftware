    ...
    <section className="pl-[15px] lg:pl-[36px] pt-[24px] pr-[36px]">
      <div className="md:flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="py-1 px-3 rounded text-sm text-black bg-[#CCCCCC]">
            Edit
          </button>
          <button className="py-1 px-3 rounded text-sm text-black bg-[#CCCCCC]">
            Statement
      ...
      <div className="border-b inline-block mt-12">
        <button className="py-1 px-10 border-b border-transparent hover:border-[#2825CB] text-[#2825CB] text-sm duration-500">Bills</button>
        <button className="py-1 px-10 border-b border-transparent hover:border-[#2825CB] text-[#2825CB] text-sm duration-500">Transactions</button>
      </div>
...
export default BaltraElectronics;
