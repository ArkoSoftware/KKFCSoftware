...
const NewBill = () => {
  return (
    <section className="pl-[15px] lg:pl-[36px] pt-[24px] pr-[36px] pb-20">
      ...
      <p className="mt-8">Billing</p>
      <p className="border-b text-sm text-gray-400">
        Billing details appear in your bill. Bill Date is used in the dashboard
        and reports. Select the date you expect to pay as the Due Date.{" "}
      </p>

      <div className="flex justify-between items-center mt-9">
        <div className="border bg-gray-300 rounded-[15px] py-10 px-16">
      ...
      <div className="flex justify-end gap-16 mt-5">
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-3 text-sm">
            <p>Total</p>
            <select name="" id="" className="input input-bordered input-sm text-sm">
